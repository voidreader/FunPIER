...
namespace PlatformerPro
{
	...
	public class GroundMovement_Physics: GroundMovement, IPhysicsMovement
	{
		...
		override public void DoMove()
		{
			...
			float actualMaxSpeed = GetSpeed (maxSpeed);
			...
			{
				character.AddVelocity((useAnalogueInput ? character.Input.HorizontalAxis : (float)character.Input.HorizontalAxisDigital) * actualAcceleration * TimeManager.FrameTime, 0, false);
				hasAppliedForce = true;
			}
