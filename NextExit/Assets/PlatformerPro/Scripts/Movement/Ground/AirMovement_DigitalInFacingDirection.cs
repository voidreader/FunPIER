...
public class AirMovement_DigitalInFacingDirection : AirMovement_Digital
{
	...
	/// </summary>
	private const string Description = "Air movement which moves only in the facing direction. NOTE: This is a sample from the tutorial (see https://jnamobile.zendesk.com/hc/en-gb/articles/218342147-Extending-Movements-A-Worked-Example ).";
