...
namespace PlatformerPro
{
	...
	public abstract class Movement : MonoBehaviour
	{
		...
		virtual public Movement Implementation 
		{
			get
			{
				return this;
		...
		/// </summary>
		protected void AssignReferences(Character character)
		{
		...
		{
			if (character == null) return "No character has been assigned after Init, if you don't call Movement.Init() you need to do this yourself.";
			if (conditions == null) return "Conditions not initialised after Init, if you don't call Movement.Init() you need to do this yourself.";
			return null;
		}
		...
		virtual public bool ForceMaintainControl()
		{
			return false;
		}
		...
		/// </summary>
		/// <returns><c>true</c> if control is wanted, <c>false</c> otherwise.</returns>
		virtual public bool CheckAdditionalConditions()
		{
			if (conditions != null)
			{
		...
		/// </summary>
		virtual public void ConditionsActivated()
		{
			if (conditions != null)
			{
				foreach (AdditionalCondition condition in conditions)
		...
		virtual public List<ValidationResult> ValidateMovement(Character c)
		{
