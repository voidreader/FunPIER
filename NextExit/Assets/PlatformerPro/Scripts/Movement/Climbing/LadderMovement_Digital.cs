...
namespace PlatformerPro
{
	...
	/// </summary>
	public class LadderMovement_Digital : ClimbMovement
	{
		...
		/// Human readable name.
		/// </summary>
		private const string Name = "Climb/Ladder/Digital";
		
		/// <summary>
		/// Human readable description.
		/// </summary>
		private const string Description = "Ladder movement which allows simple fixed speed climbing. It has several options defining how you dismount the ladder.";
		...
		override public bool ForceMaintainControl()
		{
			...
			// Early out the ladder is gone or disabled
			if (character.CurrentLadder == null || !character.CurrentLadder.enabled ) return false;
