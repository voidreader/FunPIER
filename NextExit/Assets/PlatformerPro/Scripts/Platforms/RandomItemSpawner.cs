...
namespace PlatformerPro
{
	...
	public class RandomItemSpawner : MonoBehaviour
	{
		...
		/// </summary>
		public event System.EventHandler <System.EventArgs> Spawned;

		/// <summary>
		/// Raises the spawned event.
		/// </summary>
		protected void OnSpawned() {
			if (Spawned != null) Spawned(this, new System.EventArgs());
		}

		/// <summary>
		/// Spawn this instance.
		/// </summary>
		/// <returns>true if there are items left to spawn or false otherwise.</returns>
		public bool Spawn()
		{
