...
namespace PlatformerPro
{
	...
	public class EnemyMovement_Damage_PlayAnimationOnly : EnemyDeathMovement
	{
		...
		/// </summary>
		[Tooltip ("On death the GameObject will be destroyed after this many seconds. Use 0 to skip destorying the enemy (for example if you want to set up a pool or alternative death actions.")]
