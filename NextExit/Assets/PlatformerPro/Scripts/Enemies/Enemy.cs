...
namespace PlatformerPro
{
	...
	public class Enemy : PersistableObject, IMob
	{
		...
		virtual public EnemyMovement CurrentMovement
		{
			get 
			{
				if (State == PlatformerPro.EnemyState.DAMAGED && damageMovement != null) return damageMovement;
		...
		override protected void PostInit()
		{
			...
			if (damageMovement != null && damageMovement != deathMovement) damageMovement.Init(this);
		...
		virtual protected void DoUpdate()
		{
			...
			if (enabled)
			{
				...
				else if (State == EnemyState.DAMAGED && damageMovement != null)
				{
					// Movement
