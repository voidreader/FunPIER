...
namespace PlatformerPro.Extras
{
	...
	/// Pressing up/down moves a pointer through the items and pressing 
	/// ENTER, SPACE, jump of action button 1 activates selected item.
	/// items may optionallyhave handling for left and right directions.
	/// </summary>
	public class UIBasicMenu : UIScreen, IMenu
	{
		...
		override public string Header
		{
			get
			{
				return "User interface for a very simple menu made of text items. " +
					   "Pressing up/down moves a pointer through the items and pressing " +
					   "ENTER, SPACE, Jump or Action Button 1 activates selected item.";
			}
		}
