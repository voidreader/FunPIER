...
namespace PlatformerPro
{
	...
	/// </summary>
	public class DeactivatedCondition : AdditionalCondition 
	{
		/// <summary>
		...
		/// </summary>
		[Tooltip ("The item that must be deactive.")]
		public string itemId;

		/// <summary>
		/// The deactivate when activated.
		/// </summary>
		[Tooltip ("If true the activated item will be activated when this triggers")]
		public bool activateWhenActivated;
		...
		override public void Activated(Character character, object other)
		{
			...
			if (activateWhenActivated) group.Activate (itemId);
		}
