...
namespace PlatformerPro
{
	...
	public class LevelManagerData
	{
		...
		public LevelManagerData(string activeRespawnPoint, List<string>  enabledRespawnPoints, List<LevelLockData> levelLockData, string lastEnteredScence)
		{
            ...
            this.lastEnteredScene = lastEnteredScence;
