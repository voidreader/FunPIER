...
namespace PlatformerPro
{
	...
	public class PlatformerProWelcomePopUp : EditorWindow
	{
		...
		{ 
			// Add listener so we can call unity functions next frame (we cant call them in the static initialiser)
		...
		public static void ShowWelcomeScreen()
		{
			...
			Rect rect = new Rect((Screen.width - windowWidth) / 2.0f,
								 (Screen.height - windowHeight) / 2.0f,
