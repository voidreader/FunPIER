...
namespace PlatformerPro
{
	...
	/// </summary>
	public class AirMovement_Variable : AirMovement
	{
		...
		/// Human readable name.
		/// </summary>
		private const string Name = "Digital/Variable Height Jump";
		
		/// <summary>
		/// Human readable description.
		/// </summary>
		private const string Description = "Air movement which has a variable jump height and fixed air speed.";
		...
		{
			if ( ignoredJumpCount == 1 )
				RPGSoundManager.Instance.PlayEffectSound( 1 );
			else if ( ignoredJumpCount == 2 )
				RPGSoundManager.Instance.PlayEffectSound( 2 );
			jumpStart = true;
			...
			//KJH:: 점프 블럭으로 점프를 하여도 2단 점프가 되도록 한다. 
			jumpCount = 1;
		}
