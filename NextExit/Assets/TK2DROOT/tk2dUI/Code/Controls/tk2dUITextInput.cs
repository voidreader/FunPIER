...
public class tk2dUITextInput : MonoBehaviour
{
    ...
    private void SetCursorPosition()
    {
        ...
        if (inputLabel.Textanchor == RPGTextMesh.TEXT_ANCHOR.MiddleLeft || 
            inputLabel.Textanchor == RPGTextMesh.TEXT_ANCHOR.LowerLeft ||
            inputLabel.Textanchor == RPGTextMesh.TEXT_ANCHOR.UpperLeft)
        {
            multiplier = 2;
        }
        ...
        if (inputLabel.Textanchor == RPGTextMesh.TEXT_ANCHOR.MiddleRight ||
            inputLabel.Textanchor == RPGTextMesh.TEXT_ANCHOR.LowerRight ||
            inputLabel.Textanchor == RPGTextMesh.TEXT_ANCHOR.UpperRight)
        {
            multiplier = -2;
            cursorOffset = 0.012f;
        }
