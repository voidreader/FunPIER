...
namespace TypeReferences {
	...
	public sealed class ClassTypeReferencePropertyDrawer : PropertyDrawer {
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            int btnWidth = 50;
            Rect selectionRect = new Rect(position);
            ...
            if(click) {
                ...
                if (type != null) {
                    ...
                    foreach(var asset in assets) {
                        string asetPath = AssetDatabase.GUIDToAssetPath(asset);
                        MonoScript script = AssetDatabase.LoadAssetAtPath(asetPath, typeof(MonoScript)) as MonoScript;
