...
namespace SA.Foundation.Editor
{
    ...
    {
        const string DESCRIBTION_TEXT = "This ScriptableObject hold's plugin setting. " +
        ...
        SA_PluginActiveTextLink m_aboutScriptableObjects;
        SA_PluginActiveTextLink m_pluginSettings;
        SA_PluginActiveTextLink m_documentation;
