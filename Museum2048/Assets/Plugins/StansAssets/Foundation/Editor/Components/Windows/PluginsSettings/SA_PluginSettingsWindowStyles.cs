...
namespace SA.Foundation.Editor
{
    public static class SA_PluginSettingsWindowStyles
    {
        ...
        static GUIStyle m_separationStyle = null;

        public static GUIStyle SeparationStyle
        {
            get
            {
                if (m_separationStyle == null) m_separationStyle = new GUIStyle();
        ...
        public static GUIStyle LabelServiceBlockStyle
        {
            get
            {
                if (m_labelServiceBlockStyle == null)
                {
                    ...
                    m_labelServiceBlockStyle.font = SA_EditorAssets.GetFontAtPath(SA_Config.StansAssetsEditorFonts + "Raleway-Light.ttf");
                    if (EditorGUIUtility.isProSkin)
        ...
        static GUIStyle m_labelHeaderStyle = null;
        ...
        public static GUIStyle LabelHeaderStyle
        {
            get
            {
                ...
                if (EditorGUIUtility.isProSkin) m_labelHeaderStyle.normal.textColor = SA_IconManager.GetColorFromHtml("#F8F8F8FF");

                return m_labelHeaderStyle;
            }
        }

        static GUIStyle m_describtionLabelStyle = null;
        ...
        public static GUIStyle DescribtionLabelStyle
        {
            get
            {
                ...
                if (EditorGUIUtility.isProSkin) m_describtionLabelStyle.normal.textColor = SA_IconManager.GetColorFromHtml("#959995FF");

                return m_describtionLabelStyle;
            }
        }

        static GUIStyle m_versionLabelStyle = null;

        public static GUIStyle VersionLabelStyle
        {
            get
            {
                if (m_versionLabelStyle == null) m_versionLabelStyle = new GUIStyle(DescribtionLabelStyle);
        ...
        static GUIStyle m_selectebleLabelStyle = null;
        ...
        static GUIStyle m_serviceBlockHeader = null;
        ...
        public static Color SelectedElementColor
        {
            get
            {
                if (EditorGUIUtility.isProSkin)
                    return SA_IconManager.GetColorFromHtml("#1BE1F2ED");
                else // SA_IconManager.GetColorFromHtml("#3AA3B2ED");
        ...
        public static Color ProDisabledImageColor => SA_IconManager.GetColorFromHtml("#999999ED");

        public static Color GeryGainsboroColor => SA_IconManager.GetColorFromHtml("#DCDCDC");

        public static Color GerySilverColor => SA_IconManager.GetColorFromHtml("#C0C0C0");
