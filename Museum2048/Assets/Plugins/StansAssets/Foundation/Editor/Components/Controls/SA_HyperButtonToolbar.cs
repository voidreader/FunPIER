...
namespace SA.Foundation.Editor
{
    ...
    public class SA_HyperToolbar
    {
        ...
        [SerializeField]
        float m_itemsSapce = 5f;
        [SerializeField]
        List<SA_HyperLabel> m_buttons = new List<SA_HyperLabel>();

        public void AddButtons(params SA_HyperLabel[] buttons)
        {
            if (m_buttons == null) m_buttons = new List<SA_HyperLabel>();
        ...
        /// Toolbar buttons
        /// </summary>
        public List<SA_HyperLabel> Buttons => m_buttons;
