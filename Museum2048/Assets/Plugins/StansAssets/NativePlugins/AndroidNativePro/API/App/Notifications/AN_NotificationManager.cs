...
namespace SA.Android.App {
    ...
    public static class AN_NotificationManager
    {
        ...
        const string SCHEDULED_NOTIFICATIONS_LIST_PREFS_KEY = "SCHEDULED_NOTIFICATIONS_LIST_PREFS_KEY";
        ...
        public static void Cancel(int Identifier) {
            AN_Java.Bridge.CallStatic(AN_NOTIFICATIONS_MANAGER, "Cancel", Identifier);
        }
        ...
        public static void Schedule(AN_NotificationRequest request) {
            ...
            AN_Java.Bridge.CallStatic(AN_NOTIFICATIONS_MANAGER, "Schedule", request);
        }
        ...
        public static void Unschedule(int Identifier) {
            AN_Java.Bridge.CallStatic(AN_NOTIFICATIONS_MANAGER, "Unschedule", Identifier);
        }


        public static void UnscheduleAll() {
            var list = GetScheduledList();
            foreach(int id in list.Ids) {
                Unschedule(id);
            }
            PlayerPrefs.DeleteKey(SCHEDULED_NOTIFICATIONS_LIST_PREFS_KEY);
        }
        ...
        public static void CreateNotificationChannel(AN_NotificationChannel channel) {
            AN_Java.Bridge.CallStatic(AN_NOTIFICATIONS_MANAGER, "CreateNotificationChannel", JsonUtility.ToJson(channel));
        }
        ...
        public static List<AN_NotificationChannel> GetNotificationChannels() {
            ...
            string json = AN_Java.Bridge.CallStatic<string>(AN_NOTIFICATIONS_MANAGER, "GetNotificationChannels");
        ...
        public static AN_NotificationChannel GetNotificationChannel(string channelId) {
            ...
            string json = AN_Java.Bridge.CallStatic<string>(AN_NOTIFICATIONS_MANAGER, "GetNotificationChannel", channelId);
        ...
        public static void DeleteNotificationChannel(string channelId) {
            AN_Java.Bridge.CallStatic(AN_NOTIFICATIONS_MANAGER, "DeleteNotificationChannel", channelId);
        }
        ...
        public static AN_NotificationRequest LastOpenedNotificationRequest {
            get {
                string json = AN_Java.Bridge.CallStatic<string>(AN_NOTIFICATIONS_MANAGER, "GetLastOpenNotification");
        ...
        public static SA_iEvent<AN_NotificationRequest> OnNotificationClick {
            get {
                ...
                if(s_onNotificationClick == null) {
                    ...
                    AN_Java.Bridge.CallStaticWithCallback<AN_NotificationRequest>(AN_NOTIFICATIONS_MANAGER, "Subscribe", (result) => {
        ...
        public static SA_iEvent<AN_NotificationRequest> OnNotificationReceived {
            get {
                ...
                if (s_onNotificationReceived == null) {
                    ...
                    AN_Java.Bridge.CallStaticWithCallback<AN_NotificationRequest>(AN_NOTIFICATIONS_MANAGER, "SubscribeToNotificationReceived", (result) => {
        ...
        private static void ValidateRequest(AN_NotificationRequest request) {
            ...
            AN_NotificationCompat.Builder builder = request.Content;
            ...
            string chanelId = builder.ChanelId;
        ...
        private static ScheduledNotificationsList GetScheduledList() {
            ...
            if (PlayerPrefs.HasKey(SCHEDULED_NOTIFICATIONS_LIST_PREFS_KEY)) {
                string json = PlayerPrefs.GetString(SCHEDULED_NOTIFICATIONS_LIST_PREFS_KEY);
        ...
        private static void SaveScheduledNotificationsList(ScheduledNotificationsList list) {
            ...
            PlayerPrefs.SetString(SCHEDULED_NOTIFICATIONS_LIST_PREFS_KEY, json);
        }
