...
namespace SA.Android.GMS.Games
{
    ...
    public class AN_ScoreSubmissionData : AN_LinkedObject
    {
        ...
        /// </summary>
        public string LeaderboardId => AN_GMS_Lib.Leaderboards.ScoreSubmissionData_GetLeaderboardId(this);

        /// <summary>
        /// Retrieves the ID of the player the score was submitted for.
        /// </summary>
        public string PlayerId => AN_GMS_Lib.Leaderboards.ScoreSubmissionData_GetPlayerId(this);
        ...
        public class Result : AN_LinkedObject
        {
            ...
            /// </summary>
            public string FormattedScore => AN_GMS_Lib.Leaderboards.ScoreSubmissionDataResult_GetFormattedScore(this);

            /// <summary>
            /// Indicating whether or not this score was the player's new best score for this time span.
            /// </summary>
            public bool NewBest => AN_GMS_Lib.Leaderboards.ScoreSubmissionDataResult_GetNewBest(this);

            /// <summary>
            /// The raw score value of this score result.
            /// </summary>
            public long RawScore => AN_GMS_Lib.Leaderboards.ScoreSubmissionDataResult_GetRawScore(this);

            /// <summary>
            /// The score tag associated with this result, if any.
            /// </summary>
            public string ScoreTag => AN_GMS_Lib.Leaderboards.ScoreSubmissionDataResult_GetScoreTag(this);
        }
    }
}
