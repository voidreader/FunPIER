...
{
    class AN_GMS_Native_AuthAPI : AN_iGMS_AuthAPI
    {
        //--------------------------------------
        ...
        {
            var json = AN_Java.Bridge.CallStatic<string>(AN_GoogleSignIn, "GetClient", gso.HashCode);
            return JsonUtility.FromJson<AN_GoogleSignInClient>(json);
        }

        public AN_GoogleSignInAccount GoogleSignIn_GetLastSignedInAccount()
        {
            var json = AN_Java.Bridge.CallStatic<string>(AN_GoogleSignIn, "GetLastSignedInAccount");
            if (json != null)
        ...
        {
            var json = AN_Java.Bridge.CallStatic<string>(AN_GoogleSignInOptionsBuilder, "Build", builder.HashCode);
