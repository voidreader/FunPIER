...
namespace SA.Android.GMS.Common
{
    ...
    public class AN_LinkedObjectResult<T> : SA_Result, ISerializationCallbackReceiver where T : AN_LinkedObject
    {
        ...
        public AN_LinkedObjectResult(SA_Error error)
            : base(error) { }
        ...
        public T Data
        {
            get
            {
                if (m_linkedObject.HashCode == AN_LinkedObject.k_NullObjectHash) return null;
        ...
        public void OnAfterDeserialize()
        {
            ...
            if (Data == null) m_error = new SA_Error(NATIVE_API_NULL_OBJECT_RESPONSE, "Native API responded with a null object");
        }
    }
}
