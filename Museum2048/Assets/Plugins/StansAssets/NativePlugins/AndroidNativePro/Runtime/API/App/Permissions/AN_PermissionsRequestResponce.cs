    ...
    public class AN_PermissionsRequestResponce
    {
        ...
        public AMM_ManifestPermission Permission
        {
            get
            {
                ...
                foreach (var perm in (AMM_ManifestPermission[])Enum.GetValues(typeof(AMM_ManifestPermission)))
        ...
        /// </summary>
        public AN_PackageManager.PermissionState GrantResult => (AN_PackageManager.PermissionState)m_grantResult;
    }
}
