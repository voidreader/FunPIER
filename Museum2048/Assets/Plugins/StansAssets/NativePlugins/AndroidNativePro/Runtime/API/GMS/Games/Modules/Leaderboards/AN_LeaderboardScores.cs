...
namespace SA.Android.GMS.Games
{
    ...
    public class AN_LeaderboardScores : AN_LinkedObject
    {
        ...
        /// </summary>
        public AN_Leaderboard Leaderboard => AN_GMS_Lib.Leaderboards.LeaderboardScores_GetLeaderboard(this);

        /// <summary>
        /// The leaderboard scores that were requested. Could be empty. 
        /// The listener must close this object when finished.
        /// </summary>
        public AN_LeaderboardScoreBuffer Scores => AN_GMS_Lib.Leaderboards.LeaderboardScores_GetScores(this);
    }
}
