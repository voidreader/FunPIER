...
#pragma warning disable 414
            [SerializeField]
            List<AN_LeaderboardScore> m_scores = new List<AN_LeaderboardScore>();
#pragma warning restore 414

            public List<AN_LeaderboardScore> Scores => m_scores;
        }
        ...
        public List<AN_LeaderboardScore> Scores
        {
            get
            {
                var list = AN_GMS_Lib.Leaderboards.LeaderboardScoreBuffer_GetScores(this);
                return list.Scores;
            }
        }
    }
