...
namespace SA.Android.GMS.Games
{
    ...
    public class AN_Achievement
    {
        ...
        [SerializeField]
        string m_achievementId = null;
        [SerializeField]
        string m_description = null;
        [SerializeField]
        string m_name = null;
        [SerializeField]
        string m_unlockedImageUri = null;
