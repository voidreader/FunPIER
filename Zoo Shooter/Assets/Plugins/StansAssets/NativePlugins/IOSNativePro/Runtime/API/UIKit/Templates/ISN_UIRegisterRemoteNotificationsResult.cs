...
namespace SA.iOS.UIKit
{
    ...
    {
        [SerializeField] string m_deviceTokenUTF8 = null;


        /// <summary>
        /// The UFT8 string representation of <see cref="DeviceToken"/>
        /// </summary>
        public string DeviceTokenUTF8 {
            get {
                return m_deviceTokenUTF8;
            }
        }
        ...
        /// <see cref="IdentifierForVendor"/> property of <see cref="ISN_UIDevice"/>, for security and privacy reasons, 
        /// it must change when the device is wiped.
        /// </summary>
        public byte[] DeviceToken {
            get {
                
                return Encoding.UTF8.GetBytes(m_deviceTokenUTF8);
            }
        }
