...
{
    internal class ISN_AVKitNativeAPI : ISN_Singleton<ISN_AVKitNativeAPI>, ISN_iAVKitAPI
    {

#if (UNITY_IPHONE || UNITY_IOS || UNITY_TVOS) && AVKIT_API_ENABLED
        [DllImport("__Internal")] static extern void _ISN_AV_ShowPlayerViewController(string json);
#endif
