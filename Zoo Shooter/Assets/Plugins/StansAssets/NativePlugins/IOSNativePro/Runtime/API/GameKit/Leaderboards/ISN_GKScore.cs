...
namespace SA.iOS.GameKit
{
    ...
    {
        [SerializeField] private long m_rank = 0;
        [SerializeField] private long m_value = 0;
        [SerializeField] private long m_context = 0;
        [SerializeField] private long m_date = 0;

        [SerializeField] string m_formattedValue = null;
        [SerializeField] string m_leaderboardIdentifier = null;
        [SerializeField] ISN_GKPlayer m_player  = null;
