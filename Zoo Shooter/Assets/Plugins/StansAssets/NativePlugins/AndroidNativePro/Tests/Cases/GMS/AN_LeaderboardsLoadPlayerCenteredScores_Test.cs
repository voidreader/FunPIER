...
{
    public class AN_LeaderboardsLoadPlayerCenteredScores_Test : AN_LeaderboarSingleBase_Test
    {

       
        protected override void TestLeaderboard(AN_Leaderboard leaderboard, AN_LeaderboardsClient client) {
            client.LoadPlayerCenteredScores(leaderboard.LeaderboardId, PAGE_ITEMS_COUNT, (result) => {
