...
namespace SA.Android.Vending.BillingClient
{
    ...
    public class AN_BillingClient : AN_LinkedObject
    {
        ...
        public class Builder : AN_LinkedObject
        {
            ...
            /// </summary>
            public void EnablePendingPurchases()
            {
            ...
            public void SetChildDirected(ChildDirected childDirected)
            {
                AN_Java.Bridge.CallStatic(k_NativeBillingClientBuilder, 
                    "SetChildDirected", 
                    HashCode, 
            ...
            public void SetUnderAgeOfConsent(UnderAgeOfConsent underAgeOfConsent)
            {
                AN_Java.Bridge.CallStatic(k_NativeBillingClientBuilder, 
            ...
            public void SetListener(AN_iPurchasesUpdatedListener listener)
            {
