...
{
    private AndroidJavaObject rewardedVideoObject;
    ...
    public IronSourceRewardedVideoAndroid(): base(IronSourceConstants.rewardedVideoBridgeListenerClass)
    {
        try
        {
            ...
            {
                rewardedVideoObject = pluginClass.CallStatic<AndroidJavaObject>("getInstance");
                rewardedVideoObject.Call("setUnityRewardedVideoListener", this);
            }
        }
        catch(Exception e)
        {
    ...
    //implement Rewarded Video callbacks in the bridge
    public void CreateRewardedVideo()
    {
        try
        {
            rewardedVideoObject.Call("createRewardedVideo");
        }
        catch(Exception e)
        {
            Debug.LogError("createRewardedVideo method doesn't exist, error: " + e.Message);
        }
    }
