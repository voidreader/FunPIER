...
public class IronSourceInterstitialAndroid : AndroidJavaProxy, IUnityInterstitial
{
    ...
    public IronSourceInterstitialAndroid() : base(IronSourceConstants.interstitialBridgeListenerClass)
    {
        try
        {
            ...
            {
                interstitialObject = pluginClass.CallStatic<AndroidJavaObject>("getInstance");
            }
    
            interstitialObject.Call("setUnityInterstitialListener", this);
        }
        catch(Exception e)
        {
    ...
    //implement Interstitial callbacks in the bridge
    public void CreateInterstitial()
    {
        try
        {
            interstitialObject.Call("createInterstitial");
        }
        catch(Exception e)
        {
            Debug.LogError("createInterstitial method doesn't exist, error: " + e.Message);
        }
    }
