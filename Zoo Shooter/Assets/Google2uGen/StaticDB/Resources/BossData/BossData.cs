...
namespace Google2u
{
	...
	public sealed class BossData : IGoogle2uDB
	{
		...
		private BossData()
		{
			...
			Rows.Add( new BossDataRow("boss43", "10", "43", "GasMask", "Gas Mask", "80", "gasmask"));
			Rows.Add( new BossDataRow("boss44", "10", "44", "Clown", "Clown", "90", "clown"));
			Rows.Add( new BossDataRow("boss45", "10", "45", "S.Witch", "S.Witch", "95", "S.witch"));
			Rows.Add( new BossDataRow("boss46", "11", "46", "Surprise", "Surprise Man", "80", "Surprise"));
			Rows.Add( new BossDataRow("boss47", "11", "47", "Freddy", "Cute Freddy", "90", "Freddy"));
			Rows.Add( new BossDataRow("boss48", "11", "48", "Hotkey", "Hotkey", "100", "hotkey"));
			Rows.Add( new BossDataRow("boss49", "11", "49", "Texas", "Texas Man", "90", "Texas"));
			Rows.Add( new BossDataRow("boss50", "11", "50", "Trick", "Trick", "100", "Trick"));
			Rows.Add( new BossDataRow("boss51", "12", "51", "BadPenguin", "Bad Penguin", "90", "badpenguin"));
			Rows.Add( new BossDataRow("boss52", "12", "52", "CatAunt", "Cat Aunt", "105", "cataunt"));
			Rows.Add( new BossDataRow("boss53", "12", "53", "Halface", "Half Face", "102", "halface"));
			Rows.Add( new BossDataRow("boss54", "12", "54", "Pigin", "Pig In", "110", "pigin"));
			Rows.Add( new BossDataRow("boss55", "13", "55", "Alien-Yo", "Alien-Yo", "70", "Alien-Yo"));
			Rows.Add( new BossDataRow("boss56", "13", "56", "Princess-A", "Princess-A", "80", "Princess-A"));
			Rows.Add( new BossDataRow("boss57", "13", "57", "Hero-Je", "Hero-Je", "90", "Hero-Je"));
			Rows.Add( new BossDataRow("boss58", "13", "58", "Father", "Big Daddy", "110", "father"));
			Rows.Add( new BossDataRow("boss59", "14", "59", "R.Harry", "R.Harry", "88", "R.harry"));
			Rows.Add( new BossDataRow("boss60", "14", "60", "R.Marv", "R.Marv", "92", "R.marv"));
			Rows.Add( new BossDataRow("boss61", "14", "61", "Gevin", "Gevin Lonely", "100", "Gevin"));
			Rows.Add( new BossDataRow("boss62", "15", "62", "PinkRabbit", "Pink Rabbit", "80", "PinkRabbit"));
			Rows.Add( new BossDataRow("boss63", "15", "63", "HorrorNurse", "Horror Nurse", "99", "horrornurse"));
			Rows.Add( new BossDataRow("boss64", "15", "64", "Triangle", "Triangle", "104", "triangle"));
			Rows.Add( new BossDataRow("boss65", "16", "65", "Dr.Bald", "Dr.Bald", "88", "Dr.bald"));
			Rows.Add( new BossDataRow("boss66", "16", "66", "Greenman", "Greeny", "96", "greenman"));
			Rows.Add( new BossDataRow("boss67", "16", "67", "Chief-buggle", "Chief-Buggle", "99", "Chief-buggle"));
			Rows.Add( new BossDataRow("boss68", "16", "68", "Lizard", "Lizard", "108", "Lizard"));
			Rows.Add( new BossDataRow("boss69", "16", "69", "Sand", "Sandy", "115", "Sand"));
			Rows.Add( new BossDataRow("boss70", "17", "70", "MagicGirl", "Enchanter", "92", "MagicGirl"));
			Rows.Add( new BossDataRow("boss71", "17", "71", "Killer", "Ugly Croc", "96", "Killer"));
			Rows.Add( new BossDataRow("boss72", "17", "72", "ShooterMan", "Head Shot", "100", "ShooterMan"));
			Rows.Add( new BossDataRow("boss73", "17", "73", "Diablo", "Diablo", "110", "Diablo"));
			Rows.Add( new BossDataRow("boss74", "17", "74", "Hollyshit", "Holly Queen", "106", "hollyshit"));
			Rows.Add( new BossDataRow("boss75", "17", "75", "Pocker", "Poker", "114", "poker"));
			Rows.Add( new BossDataRow("boss76", "18", "76", "FishMan", "Walking Fish", "82", "FishMan"));
			Rows.Add( new BossDataRow("boss77", "18", "77", "StarFish", "Star Fish", "88", "StarFish"));
			Rows.Add( new BossDataRow("boss78", "18", "78", "Sparrow", "Sparrow", "94", "sparrow"));
			Rows.Add( new BossDataRow("boss79", "18", "79", "Octo-Johns", "Octo-Johns", "100", "Octo-Johns"));
			Rows.Add( new BossDataRow("boss80", "19", "80", "ryu", "White Fighter", "88", "ryu"));
			Rows.Add( new BossDataRow("boss81", "19", "81", "ken", "Red Fighter", "92", "ken"));
			Rows.Add( new BossDataRow("boss82", "19", "82", "Dhalim", "Darling", "96", "Dhalim"));
			Rows.Add( new BossDataRow("boss83", "19", "83", "Guile", "AlliGuile", "100", "Guile"));
			Rows.Add( new BossDataRow("boss84", "19", "84", "Chun-li", "Street Girl", "110", "Chun-li"));
			Rows.Add( new BossDataRow("boss85", "19", "85", "HeyGrandfa", "Tekken Papa", "120", "heygrandfa"));
		}
