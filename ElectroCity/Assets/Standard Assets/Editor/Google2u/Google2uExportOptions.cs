...
namespace Google2u
{
    ...
    public class Google2uExportOptions
    {
        ...
        public Google2uExportOptions(string in_prefix)
        {
            ...
            JSONExportSingleSubfolder = Google2uGUIUtil.GetBool(in_prefix + "JSONExportSingleSubfolder", JSONExportSingleSubfolder);
            #endregion
            ...
            XMLExportSingleSubfolder = Google2uGUIUtil.GetBool(in_prefix + "XMLExportSingleSubfolder", XMLExportSingleSubfolder);
            ...
            CSVExportSingleSubfolder = Google2uGUIUtil.GetBool(in_prefix + "CSVExportSingleSubfolder", CSVExportSingleSubfolder);
        ...
        public bool JSONExportSingleSubfolder;
        ...
        public bool XMLExportSingleSubfolder;
        ...
        public bool CSVExportSingleSubfolder;
