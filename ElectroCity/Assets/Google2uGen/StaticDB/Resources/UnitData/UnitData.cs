...
namespace Google2u
{
	...
	public sealed class UnitData : IGoogle2uDB
	{
		...
		private UnitData()
		{
			...
			Rows.Add( new UnitDataRow("U32", "U32", "32", "unit32", "14,072,702,117", "100", "16", "684400", "32", "32", "32_body", "32_leg", "0.02", "-0.333", "32_face_idle", "32_face_shoot", "0.075", "0.264", "gunParts4", "-0.382", "0.445"));
