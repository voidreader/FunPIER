...
namespace SA.Android.Gallery.Internal
{
    internal static class AN_GalleryInternal 
    {
        ...
        public static void StartNativeImageCaptureIntent(Action<AN_Media> callback) {            
            AN_Java.Bridge.CallStaticWithCallback<AN_Media>(AN_MEDIASTORE_CLASS, "TakePicture", callback);
        }
