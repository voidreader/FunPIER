...
/// 「サクッと空気読み。」のステージ選択シーン。
/// </summary>
public class KySceneGameInfo : KyScene {
	...
	void Start () {
		//	タイトルラベルの設定
		KyUtil.SetText(gameObject, "navi/label", KyText.GetText(20106));
		//	メニューアイテムの設定
		ArrayList dataSet = new ArrayList();
		dataSet.Add(new KyButtonLabeled.Data(0, KyText.GetText(20085)));
		dataSet.Add(new KyButtonLabeled.Data(1, KyText.GetText(20086)));
	...
	private int MainMenuButtonSelected(object sender) {
		if (MainList.SelectedButtonIndex == 0) {
			Application.OpenURL("http://kuukiyomi.com/sp");
