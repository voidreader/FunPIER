    ...
    public class AnimatedGifPlayer : MonoBehaviour {
        ...
        private void SetTexture() {
            ...
            if (_targetComponent is SpriteRenderer) {
                ...
                var newSprite = UnityEngine.Sprite.Create(GifTexture, new Rect(0.0f, 0.0f, GifTexture.width, GifTexture.height), new Vector2(0.5f, 0.5f), 100f, 0, SpriteMeshType.FullRect);
        ...
        private void SetTargetTexture() {
            ...
            if (TargetComponent is SpriteRenderer) {
                ...
                var newSprite = UnityEngine.Sprite.Create(GifTexture, new Rect(0.0f, 0.0f, GifTexture.width, GifTexture.height), new Vector2(0.5f, 0.5f));
                newSprite.name = "Gif Player Sprite";
                newSprite.hideFlags = HideFlags.HideAndDontSave;
                target.sprite = newSprite;
            }
