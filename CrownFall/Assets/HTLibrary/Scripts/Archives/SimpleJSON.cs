...
namespace HT
{
	...
	public class JSONNode
	{
		...
		public virtual bool Contains(string aKey) { return false; }
	...
	public class JSONArray : JSONNode, IEnumerable
	{
		...
		public override string ToString(string aPrefix)
		{
			...
			foreach (JSONNode N in m_List)
			{
				...
				result = string.Format("{0}\n{1}   {2}", result, aPrefix, N.ToString(aPrefix + "   "));
				//result += "\n" + aPrefix + "   ";
	...
	public class JSONClass : JSONNode, IEnumerable
	{
		...
		public override string ToString()
		{
			...
			foreach (KeyValuePair<string, JSONNode> N in m_Dict)
			{
				...
				result = string.Format("{0}\"{1}\":{2}", result, Escape(N.Key), N.Value.ToString());
		...
		public override string ToString(string aPrefix)
		{
			...
			foreach (KeyValuePair<string, JSONNode> N in m_Dict)
			{
				...
				result = string.Format("{0}\n{1}   \"{2}\" : {3}", result, aPrefix, Escape(N.Key), N.Value.ToString(aPrefix + "   "));
				//result += "\n" + aPrefix + "   ";
	...
	public class JSONData : JSONNode
	{
		...
		public override string ToString()
		{
			return (m_str) ? string.Format("\"{0}\"", Escape(m_Data)) : Escape(m_Data);
			//return (m_str) ? "\"" + Escape(m_Data) + "\"" : Escape(m_Data);
		}
		public override string ToString(string aPrefix)
		{
			return (m_str) ? string.Format("\"{0}\"", Escape(m_Data)) : Escape(m_Data);
