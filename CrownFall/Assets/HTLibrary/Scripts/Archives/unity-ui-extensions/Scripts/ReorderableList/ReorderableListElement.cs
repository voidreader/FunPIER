...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableListElement : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
		...
		private Vector3 _draggingObjectMousePositionOffset;
		...
		private int _grapObjSlibbingIndex = -1;
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            if (_reorderableList.CloneDraggedObject == false)
            {
				...
				Vector3 eventPosition = eventData.position;
				_draggingObjectMousePositionOffset = eventPosition - _draggingObject.position;
			...
			_grapObjSlibbingIndex = _fromIndex;
        ...
        public void OnDrag(PointerEventData eventData)
        {
			...
			_draggingObject.position -=_draggingObjectMousePositionOffset;
            ...
            else
            {
				...
				if (_reorderableList.OnElementSwapped != null && _grapObjSlibbingIndex != targetIndex)
				{
					_grapObjSlibbingIndex = targetIndex;

					_reorderableList.OnElementSwapped.Invoke(new ReorderableList.ReorderableListEventStruct
					{
						DroppedObject = _draggingObject.gameObject,
						IsAClone = _reorderableList.CloneDraggedObject,
						SourceObject = _reorderableList.CloneDraggedObject ? gameObject : _draggingObject.gameObject,
