	...
	UNITY_DECLARE_SCREENSPACE_TEXTURE(_DownsampledDepth); // was sampler2D
	...
	float minimum_distance_sqr(float fogLength, float3 w, float3 p) {
		// Return minimum distance between line segment vw and point p
  		float t = clamp(dot(p, w) / (fogLength * fogLength), 0, 1);
...
//		sum += (fogLength >= dist) * (sum.a<0.99) * fgCol * (1.0-sum.a) * dir.w; // if fog hits geometry and accumulation is less than 0.99 add remaining fraction to reduce banding
		...
		#if FOG_POINT_LIGHT0 || FOG_POINT_LIGHT1 || FOG_POINT_LIGHT2 || FOG_POINT_LIGHT3 || FOG_POINT_LIGHT4 || FOG_POINT_LIGHT5 
		float3 pldir = fogLength * adir.xyz / adir.w;
		float pointLightInfluence = minimum_distance_sqr(fogLength, pldir, _FogPointLightPosition0 - fogCeilingCut) / _FogPointLightColor0.w;
		_FogPointLightColor0.rgb = _FogPointLightColor0.rgb  / (1.0 + pointLightInfluence);
		#endif
		
		#if FOG_POINT_LIGHT1 || FOG_POINT_LIGHT2 || FOG_POINT_LIGHT3 || FOG_POINT_LIGHT4 || FOG_POINT_LIGHT5
		pointLightInfluence = minimum_distance_sqr(fogLength, pldir, _FogPointLightPosition1 - fogCeilingCut) / _FogPointLightColor1.w;
		_FogPointLightColor1.rgb = _FogPointLightColor1.rgb  / (1.0 + pointLightInfluence);
		#endif

		#if FOG_POINT_LIGHT2 || FOG_POINT_LIGHT3 || FOG_POINT_LIGHT4 || FOG_POINT_LIGHT5
		pointLightInfluence = minimum_distance_sqr(fogLength, pldir, _FogPointLightPosition2 - fogCeilingCut) / _FogPointLightColor2.w;
		_FogPointLightColor2.rgb = _FogPointLightColor2.rgb  / (1.0 + pointLightInfluence);
		#endif

		#if FOG_POINT_LIGHT3 || FOG_POINT_LIGHT4 || FOG_POINT_LIGHT5
		pointLightInfluence = minimum_distance_sqr(fogLength, pldir, _FogPointLightPosition3 - fogCeilingCut) / _FogPointLightColor3.w;
		_FogPointLightColor3.rgb = _FogPointLightColor3.rgb  / (1.0 + pointLightInfluence);
		#endif

		#if FOG_POINT_LIGHT4 | FOG_POINT_LIGHT5
		pointLightInfluence = minimum_distance_sqr(fogLength, pldir, _FogPointLightPosition4 - fogCeilingCut) / _FogPointLightColor4.w;
		_FogPointLightColor4.rgb = _FogPointLightColor4.rgb  / (1.0 + pointLightInfluence);
		#endif

		#if FOG_POINT_LIGHT5
		pointLightInfluence = minimum_distance_sqr(fogLength, pldir, _FogPointLightPosition5 - fogCeilingCut) / _FogPointLightColor5.w;
		_FogPointLightColor5.rgb = _FogPointLightColor5.rgb  / (1.0 + pointLightInfluence);
		#endif

		// Apply point lights
		#if FOG_POINT_LIGHT5
		sum.rgb += (_FogPointLightColor0.rgb + _FogPointLightColor1.rgb + _FogPointLightColor2.rgb + _FogPointLightColor3.rgb + _FogPointLightColor4.rgb + _FogPointLightColor5.rgb) * sum.a;
		#elif FOG_POINT_LIGHT4
		sum.rgb += (_FogPointLightColor0.rgb + _FogPointLightColor1.rgb + _FogPointLightColor2.rgb + _FogPointLightColor3.rgb + _FogPointLightColor4.rgb) * sum.a;
		#elif FOG_POINT_LIGHT3
		sum.rgb += (_FogPointLightColor0.rgb + _FogPointLightColor1.rgb + _FogPointLightColor2.rgb + _FogPointLightColor3.rgb) * sum.a;
		#elif FOG_POINT_LIGHT2
		sum.rgb += (_FogPointLightColor0.rgb + _FogPointLightColor1.rgb + _FogPointLightColor2.rgb) * sum.a;
		#elif FOG_POINT_LIGHT1
		sum.rgb += (_FogPointLightColor0.rgb + _FogPointLightColor1.rgb) * sum.a;
		#elif FOG_POINT_LIGHT0
		sum.rgb += _FogPointLightColor0.rgb * sum.a;
		#endif
